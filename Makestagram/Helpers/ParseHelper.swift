...
class ParseHelper {
    ...
    */
    static func removeFollowRelationshipFromUser(user: PFUser, toUser: PFUser) {
        ...
        query.findObjectsInBackgroundWithBlock {
            ...
            for follows in results {
                follows.deleteInBackgroundWithBlock(ErrorHandling.errorHandlingCallback)
            }
        }
    }
    ...
    Limits the amount of users return to 20
    ...
    */
    static func searchUsers(searchText: String, completionBlock: PFArrayResultBlock) -> PFQuery {
        ...
        lowercased usernmae in a separate column and perform a regular string compare.
        */
